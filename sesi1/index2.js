var myName = "Imam  Harits Nasruddin";
var age = 17;
console.log(myName, age);
var hobbies = ["GTA V", "Genshin Impact", "CS 1.6"];
console.log(hobbies);
var person = {
    name: "Imam",
    title: "Programmer",
...
console.log(Math.pow(myNumber, 2)); // ** simbol pangkat
var num = -12;
var res = num;
res += 10;
res += 5;
...
console.log(num3 === num4); // false karena nominalnya sama tapi tipenya berbeda
